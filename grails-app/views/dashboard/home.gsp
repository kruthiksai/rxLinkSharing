    ...
    <div class="container-fluid ">
        ...
        <div class="collapse navbar-collapse " style="float: right;" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
                ...
                <li class="nav-item">
                    <a class="nav-link " aria-current="page" href="#"><i class="fa fa-comments fa-lg" aria-hidden="true"></i></a>
                </li>
                <li class="nav-item">
...
%{--            </div>--}%
            ...
            <g:render template="/templates/subscriptionDetails" model="[trendingTopics:trendingTopics]"></g:render>
        </div>
